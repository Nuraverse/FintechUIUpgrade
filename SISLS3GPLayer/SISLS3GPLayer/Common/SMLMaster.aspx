            ...
            <div class="header_bar" id="headermenu">
                <div class="row">
                    ...
                    <div class="col d-flex">
                        <div class="col-1" id="SideMenuOpen">
                    ...
                    <div class="col header_bar_content2" align="right">
                        <div class="dropdown">
                            <button class="btn dropdown-toggle" type="button" id="dropdownMenuButton" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false" style="padding: 0px 16px; margin: 0px;" onclick="dropmenuhide()">
                            ...
                            <ul class="dropdown-menu multi-level" aria-labelledby="dropdownMenuButton" x-placement="bottom-start" id="dropmenu">
                                ...
                                <li class="dropdown-submenu">
                                    ...
                                    <asp:DropDownList ID="ddlTheme" class="dropdown-menu" runat="server" AutoPostBack="True" OnSelectedIndexChanged="ddlTheme_SelectedIndexChanged">
                                        ...
                                        <asp:ListItem class="dropdown-item" Value="S3GTheme_GREEN_LIGHT">GREEN Light</asp:ListItem>
                                    </asp:DropDownList>
        ...
        <div class="card">
          ...
          <div id="collapseThree" class="collapse" aria-labelledby="headingThree" data-parent="#accordion">
            ...
            <div class="content_base">
                ...
                <div class="row px-2" id="Container">
            ...
            <div class="footer_bar">
                <div class="row">
                    <div class="col mt-1 px-4" align="left">
                        <img src="../Images/Light/s3g_logo.png" style="width: 70px;">
                    </div>
                    <div class="col p-3 pr-4">
            ...
            try {
                if (iFrame != undefined && iFrame.src != null) {
                    for (var i = 0; i <= imgBtns.length - 1; i++) {
                        if (varTheme == 'S3GTHEME_BLUE2' || varTheme == "S3GTHEME_NIGHT" || varTheme == "S3GTHEME_LIGHT" || varTheme == "S3GTHEME_GREEN_LIGHT") {
