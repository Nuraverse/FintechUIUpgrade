...
public partial class Origination_S3GORGTransLander : ApplyThemeForProject
{
        ...
        try
        {
            ...
            switch (ProgramCode)
            {
                case strFieldInformationReportCode:
                    ...
                    strRedirectPage = "~/Marketing/S3GOrgFieldInformationReport_Add.aspx";        // page to redirect to the page in edit mode
                ...
                case strSanctionNumberCode:
                    ...
                    strRedirectPage = "~/Marketing/S3G_ORG_SanctionNumberQuery.aspx";             // page to redirect to the page in edit mode
                    break;
                //Code end
                case strProformaReportCode:
                    ...
                    strRedirectPage = "~/Marketing/S3GORGProforma_Add.aspx";                      // page to redirect to the page in edit mode
                ...
                case strPRDDTransaction:
                    ...
                    div1.Visible = false;
                    div2.Visible = false;
                    strRedirectPage = "~/Marketing/S3GOrgPDDTMaster_Add.aspx";                      // page to redirect to the page in edit mode
                    strRedirectCreatePage = strRedirectPage;
                    break;
                ...
                case strCreditParameterTransactionCode:
                    ...
                    strRedirectPage = "~/Marketing/S3G_ORG_CreditParameterTransaction.aspx";                      // page to redirect to the page in edit mode
                    strRedirectCreatePage = "~/Marketing/S3G_ORG_CreditParameterTransaction.aspx?qsMode=C";
                    break;
                ...
                case strEnquiryAssignment:
                    ...
                    strRedirectPage = "~/Marketing/S3G_ORG_EnquiryAssignment.aspx";
                ...
                case strCreditParameterApproval:
                    ...
                    strRedirectPage = "~/Marketing/S3GOrgCreditParameterApproval.aspx";
                    strRedirectCreatePage = "~/Marketing/S3GOrgCreditParameterApproval.aspx?qsMode=C";
                ...
                case strEnquiryCustomerAppraisal:
                    ...
                    strRedirectPage = "~/Marketing/S3GORGEnquiryAppraisal_Add.aspx?qsTransactionType=" + ddlMultipleDNC.SelectedValue;
                    //strRedirectCreatePage = "~/Marketing/S3GORGEnquiryAppraisal_View.aspx?qsMode=C&qsTransactionType=" + ddlMultipleDNC.SelectedValue;
                    strRedirectCreatePage = "~/Marketing/S3GORGEnquiryAppraisal_Add.aspx?qsMode=C"; //&qsTransactionType=" + ddlMultipleDNC.SelectedValue;
                    break;
                case strPricingApprovalReportCode:
                    ...
                    lblHeading.Text = "Pricing Approval - Details";
                    strRedirectPage = "~/Marketing/S3GORGPricingApproval_Add.aspx?qsMode=C";                      // page to redirect to the page in edit mode
                    strRedirectCreatePage = strRedirectPage;
                ...
                case strApplicationApproval:
                    ...
                    strRedirectPage = "~/Marketing/S3GORGApplicationApproval_Add.aspx";
                    strRedirectCreatePage = "~/Marketing/S3GORGApplicationApproval_Add.aspx?qsMode=C";
                    FunPriQueryString();
                    //btnCreate.Text = "Approve";
                    break;
                ...
                case strEnquiryResponse:
                    ...
                    strRedirectPage = "~/Marketing/S3GORGEnquiryResponse.aspx";                      // page to redirect to the page in edit mode
                    //strRedirectCreatePage = strRedirectPage;
                    strRedirectCreatePage = strRedirectPage + "?qsMode=C";
                ...
                case strApplicationProcess:
                    ...
                    //ddlDocumentNumb.Visible = true;
                    strRedirectPage = "~/Marketing/S3G_ORG_ApplicationProcessing.aspx";                      // page to redirect to the page in edit mode
                    strRedirectCreatePage = strRedirectPage + "?qsMode=C";
                ...
                case strApplicationProcessAC:
                    ...
                    lblProgramIDSearch.Visible = true;
                    //ddlDocumentNumb.Visible = true;
                    strRedirectPage = "~/Marketing/S3G_ORG_ApplicationProcessing_AC.aspx";                      // page to redirect to the page in edit mode
                    strRedirectCreatePage = strRedirectPage + "?qsMode=C";
                    ucAccountLov.strLOV_Code = "ACC_APP";
                    dvAccountNo.Visible = true;
                    btnCreate.Enabled_False();
                ...
                case strApplicationVer:
                    ...
                    lblProgramIDSearch.Visible = true;
                    //ddlDocumentNumb.Visible = true;
                    strRedirectPage = "~/Marketing/S3gOrgApplication_Verification_Add.aspx";                      // page to redirect to the page in edit mode
                    strRedirectCreatePage = strRedirectPage + "?qsMode=C";
                    dvAccountNo.Visible = true;
                    break;
                ...
                case strCustomerGroup:
                    ...
                    lblProgramIDSearch.Visible = true;
                    strRedirectPage = "~/Marketing/S3GORGCustomerGroup_Add.aspx";                      // page to redirect to the page in edit mode
                    strRedirectCreatePage = strRedirectPage + "?qsMode=C";
                    dvAccountNo.Visible = false;
                ...
                case strApplicationProcessBW:
                    ...
                    lblProgramIDSearch.Visible = true;
                    //ddlDocumentNumb.Visible = true;
                    strRedirectPage = "~/Marketing/S3G_ORG_ApplicationProcessingBW.aspx";                      // page to redirect to the page in edit mode
                    strRedirectCreatePage = strRedirectPage + "?qsMode=C";
                    break;
                case strApplicationProcessGL:
                    ...
                    lblProgramIDSearch.Visible = true;
                    //ddlDocumentNumb.Visible = true;
                    strRedirectPage = "~/Marketing/S3G_ORG_ApplicationProcessingGL.aspx";                      // page to redirect to the page in edit mode
                    strRedirectCreatePage = strRedirectPage + "?qsMode=C";
                    break;
                ...
                case strCreditGuideTransaction:
                    ...
                    lblMultipleDNC.Text = "Document Type";
                    lblProgramIDSearch.Text = "Document Number";
                    strRedirectPage = "~/Marketing/S3GORGCreditGuideTransaction_Add.aspx";                      // page to redirect to the page in edit mode
                    //strRedirectCreatePage = strRedirectPage;
                    strRedirectCreatePage = strRedirectPage + "?qsMode=C";
                    break;
                ...
                case strPricing:
                    ...
                    strRedirectPage = "~/Marketing/S3gOrgPricing_Add.aspx";                      // page to redirect to the page in edit mode                
                    strRedirectCreatePage = strRedirectPage + "?qsMode=C";
                    ddlDocumentNumb.Visible = true;
                    break;
                ...
                case strPricingBW:
                    ...
                    strRedirectPage = "~/Marketing/S3gOrgPricingBW_Add.aspx";                      // page to redirect to the page in edit mode                
                    strRedirectCreatePage = strRedirectPage + "?qsMode=C";
                    ddlDocumentNumb.Visible = true;
                    break;
                ...
                case strTargetMaster:
                    ...
                    strRedirectPage = "~/Marketing/S3GORGTargetMaster_Add.aspx";                      // page to redirect to the page in edit mode                
                    strRedirectCreatePage = strRedirectPage + "?qsMode=C";
                    ddlDocumentNumb.Visible = true;
                    break;
                ...
                case strCRM:
                    ...
                    strRedirectPage = "~/Marketing/S3GOrgCRM.aspx";
                    strRedirectCreatePage = strRedirectPage;// +"?qsMode=C";
                    ddlDocumentNumb.Visible = false;
                    FunPriMakeMultipleDNCVisible(lblDNCOption, ddlDNCOption, false);
    ...
    protected void grvTransLander_RowCommand(object sender, GridViewCommandEventArgs e)
    {
        ...
        if (ProgramCodeToCompare == strCRM)
        {
            ...
            Response.Redirect("~/Marketing/S3GOrgCRM.aspx");
        }
        ...
        switch (e.CommandName.ToLower())
        {
            case "modify":
                ...
                if (strUserRowLocked != "0")
                {
                    ...
                    {
                        // Utility.FunShowAlertMsg(this, "Proposal Number Has Been Locked By Another User"); //Commented and modified on 24-09-21
    ...
    //                case strCreditParameterTransactionCode:
    //                    ProgramCodeToCompare = strCreditParameterTransactionCode;
    //                    strRedirectPage = "~/Marketing/S3G_ORG_CreditParameterTransaction.aspx";     // page to redirect to the page                                                                  
    ...
    //    try
    //    {
    //        strRedirectPage = "~/Marketing/S3GOrgCreditParameterApproval.aspx";     // page to redirect to the page                                                                  
    //        Procparam.Add("@Company_ID", intCompanyID.ToString());
    ...
    //    try
    //    {
    //        strRedirectPage = "~/Marketing/S3GORGCreditGuideTransaction_Add.aspx";     // page to redirect to the page                                                                  
    //        Procparam.Add("@Company_ID", intCompanyID.ToString());
    ...
    private void FunPriQueryString()
    {
        ...
        {
            case strApplicationApproval:
                strRedirectPage = FunPriAddLOBBranchQueryString("~/Marketing/S3GORGApplicationApproval_Add.aspx");
                break;
        }
    }
    ...
    public static string[] GetDocumentNumberList(String prefixText, int count)
    {
        ...
        Dictionary<string, string> Procparam = new Dictionary<string, string>();
        Procparam.Clear();
        Procparam.Add("@SearchText", prefixText.Trim());
