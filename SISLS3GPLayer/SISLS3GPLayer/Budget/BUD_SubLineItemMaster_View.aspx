<%@ Page Title="" Language="C#" MasterPageFile="~/Common/FAMasterPageCollapse.master" AutoEventWireup="true"
    CodeFile="BUD_SubLineItemMaster_View.aspx.cs" Inherits="Budget_BUD_SubLineItemMaster_View" %>
            ...
            <div class="tab-pane fade in active show" id="tab1">
                ...
                <div class="row">
                    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                        <div class="gird">
                            <asp:GridView runat="server" ID="grvViewSubLineItems" Width="100%" AutoGenerateColumns="false"
                                HeaderStyle-CssClass="styleGridHeader" class="gird_details" EmptyDataText="No Records found"
                                RowStyle-HorizontalAlign="Left" ShowHeaderWhenEmpty="true" OnRowCommand="grvViewSubLineItems_RowCommand" 
                                OnRowDataBound="grvViewSubLineItems_RowDataBound">
                                <Columns>
                                    <asp:TemplateField ItemStyle-HorizontalAlign="Center" HeaderStyle-Width="8%">
                                        ...
                                        <ItemTemplate>
                                            <asp:ImageButton ID="imgbtnQuery" ToolTip="Query" ImageUrl="~/Images/spacer.gif"
                                                 CssClass="styleGridQuery" CommandArgument='<%#Eval("SUBLINEITEM_MSTRID") %>'
                                    ...
                                    <asp:TemplateField HeaderStyle-CssClass="styleGridHeader" HeaderStyle-Width="8%">
                                        ...
                                        <ItemTemplate>
                                            <asp:ImageButton ID="imgbtnEdit" CssClass="styleGridEdit" ToolTip="Modify" 
                                                ImageUrl="~/Images/spacer.gif" CommandArgument='<%#Eval("SUBLINEITEM_MSTRID") %>'
                                  ...
                                  <asp:TemplateField HeaderText="Item Header" 
                                    ...
                                    <asp:TemplateField HeaderText="Line Item"  HeaderStyle-CssClass="stylegridheader">
                                        <ItemTemplate>
