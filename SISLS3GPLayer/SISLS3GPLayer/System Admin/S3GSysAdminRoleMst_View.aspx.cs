...
public partial class System_Admin_S3GSysAdminRoleMst_View : ApplyThemeForProject
{
    ...
    string strRedirectPage = "~/System Admin/S3GSysAdminRoleMst_Add.aspx";
    ...
    private void FunGetUserDetails()
    {
        ...
        try
        {
            ...
            grvUserManagement.BindGridView("S3G_SYSAD_GRPMST_PAGING", Procparam, out intTotalRecords, ObjPaging, out bIsNewRow);
            if (bIsNewRow)
            {
    ...
    protected void FunProHeaderSearch(object sender, EventArgs e)
    {
        ...
        try
        {
            ...
            if (strSearchVal1 != "")
            {
                strSearchVal += "ROLE_NAME like '%" + strSearchVal1 + "%'";
            }
