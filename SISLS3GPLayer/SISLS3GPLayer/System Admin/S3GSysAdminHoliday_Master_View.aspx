            ...
            <div>
                ...
                <div class="row" style="margin-top: 10px; align-content: center">
                    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 gird">
                        <asp:GridView runat="server" ID="gvHolidayMaster" OnRowDataBound="gvHolidayMaster_RowDataBound"
                            OnRowCommand="gvHolidayMaster_RowCommand" Width="100%" AutoGenerateColumns="false" CssClass="gird_details"
                            ...
                            <Columns>
                                ...
                                <asp:TemplateField HeaderText="Branch" ItemStyle-HorizontalAlign="left"
                                    ...
                                    <ItemTemplate>
                                        <asp:Label ID="lbllocation" runat="server" ToolTip="Branch" Text='<%# Bind("locationcat_description") %>'></asp:Label>
                                    </ItemTemplate>
                                ...
                                <%--   <asp:TemplateField HeaderText="Date" ItemStyle-HorizontalAlign="Left"
                                    HeaderStyle-CssClass="styleGridHeader" HeaderStyle-Width="10%">
                                    <ItemTemplate>
                                        <asp:Label ID="lblDate" runat="server" ToolTip="Dimension Pattern" Text='<%# Bind("HDate") %>'></asp:Label>
                                    </ItemTemplate>
                                </asp:TemplateField>--%>
                ...
                <div class="row">
                  ...
                  <div align="right" class="fixed_btn">
                    <button class="css_btn_enabled" id="btnCreate" onserverclick="btnSave_Click" runat="server"
