<%@ Page Title="" Language="C#" MasterPageFile="~/Common/S3GMasterPageCollapse.master" AutoEventWireup="true" CodeFile="S3GSysAdminUserRoleMap_View.aspx.cs" Inherits="System_Admin_S3GSysAdminUserRoleMap_View" %>
                                                ...
                                                <tr align="center">
                                                    <th style="padding: 0px !important; background: none !important;">
                                                        <asp:LinkButton ID="lnkbtnUserGroupName" OnClick="FunProSortingColumn" CssClass="styleGridHeaderLinkBtn"
                                                            runat="server" ToolTip="Sort By User Code" Text="Role Map Name"></asp:LinkButton>
