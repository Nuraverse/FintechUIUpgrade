<%@ Page Title="" Language="C#" MasterPageFile="~/Common/S3GMasterPageCollapse.master"
    AutoEventWireup="true" CodeFile="S3G_ORG_ApplicationProcessing.aspx.cs" MaintainScrollPositionOnPostback="true" Inherits="Origination_S3G_ORG_ApplicationProcessing"
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <script type="text/javascript">
        ...
        function funCalDebtPurchase() {
            ...
            vFundLimit = vFundLimit.replace(/[^0-9\.]+/g, "");
            vDp = vDp.replace(/[^0-9\.]+/g, "");
            ...
            if (vFundLimit == null || vFundLimit == "") {
                vFundLimit = 0.000;
            }
            vMargin = 100 - vMargin;
            if (parseFloat(vMargin) > parseFloat(vFundLimit)) {
                alert('Margin Amount should be less than the Prepayment Limit');
                document.getElementById("<%= txtMarginFWC.ClientID %>").value = "";
                document.getElementById("<%= txtDebtPurchaseLimitFWC.ClientID %>").value = "";
                return;
            }
            document.getElementById("<%= txtDebtPurchaseLimitFWC.ClientID %>").value = (((parseFloat(vFundLimit) / parseFloat(vMargin)) * 100).toFixed(3));

            fnthousands_separators("ctl00_ContentPlaceHolder1_TabContainerAP_TabOfferTerms_txtPrePaymentLimitFWC", 2);
            fnthousands_separators("ctl00_ContentPlaceHolder1_TabContainerAP_TabOfferTerms_txtDebtPurchaseLimitFWC", 2);
        }
        ...
        function funPrepaymentInvoice() {
            ...
            vPrePay = vPrePay.replace(/[^0-9\.]+/g, "");
            VInvoiceValue = VInvoiceValue.replace(/[^0-9\.]+/g, "");
            ...
            fnthousands_separators("ctl00_ContentPlaceHolder1_TabContainerAP_TabOfferTerms_txtPrePaymentLimitFWC", 2);
            fnthousands_separators("ctl00_ContentPlaceHolder1_TabContainerAP_TabOfferTerms_txtInvoiceCapValue", 2);
    ...
    <asp:UpdatePanel ID="UpdatePanel2" runat="server">
        <ContentTemplate>
            ...
            <asp:Panel runat="server" ID="pnlProposalhdrDisplayDetails" CssClass="stylePanel" HorizontalAlign="Center" Width="99%" GroupingText="Proposal Details">
                ...
                <div>
                    <%--<div class="col-md-12">--%>
                    <cc1:ModalPopupExtender ID="mp1" runat="server" TargetControlID="btnShow"
                        PopupControlID="pnlRiskVal" BackgroundCssClass="styleModalBackground" Enabled="true">
                    </cc1:ModalPopupExtender>
                    <asp:Panel ID="pnlRiskVal" Style="display: none; vertical-align: middle" runat="server" GroupingText="Risk Details"
                        BorderStyle="Solid" BackColor="White" Width="40%" Height="30%" CssClass="stylePanel">
                            ...
                            <ContentTemplate>
                                ...
                                <div>
                                    ...
                                    <div align="right">
                                        ...
                                        <div class="row">
                                            <asp:Label ID="lblRiskVal" runat="server"></asp:Label>
                                        </div>
                                        <br />
                                        <br />
                                        <button class="css_btn_enabled" id="btnModalAdd" visible="true" onserverclick="btnyes_Click" runat="server" accesskey="M"
                                            type="button" causesvalidation="false" title="Yes[Alt+M]">
                                            <i class="fa fa-floppy-o" aria-hidden="true"></i>&emsp;<u>Y</u>es
                                        </button>

                                        <button class="css_btn_enabled" id="btnModalCancel" onserverclick="btnNo_Click" runat="server" causesvalidation="false" title="Hide[Alt+B]"
                                            type="button" accesskey="B">
                                            <i class="fa fa-times" aria-hidden="true"></i>&emsp;<u>N</u>o
                                        </button>
                                        <div id="progress" runat="server" class="loder_img" visible="false" >
                                ...
                                <ContentTemplate>
                                            ...
                                            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                                ...
                                                <asp:Panel ID="pnlLeaseMarkettingDetails" runat="server" GroupingText="Marketing Details"
                                                    ...
                                                    <div class="row">
                                                        ...
                                                        <div class="col-lg-3 col-md-3 col-sm-12 col-xs-12">
                                                            <div class="md-input">
                                                                <asp:DropDownList ID="ddlSubvention" AutoPostBack="true" OnSelectedIndexChanged="ddlSubvention_SelectedIndexChanged" class="md-form-control form-control" ToolTip="Subvention Applicable" runat="server">
                                                                    <asp:ListItem Value="0" Text="No" Selected="True"></asp:ListItem>
                                                                    <asp:ListItem Value="1" Text="Yes"></asp:ListItem>
                                                                ...
                                                                <span class="bar"></span>
                                                                <label class="tess">
                                                                    <asp:Label runat="server" ID="lblSubvention" ToolTip="Subvention Applicable" CssClass="styleDisplayLabel" Text="Subvention Applicable"></asp:Label>
                                                                </label>
                                                            </div>
                                                        </div>
                                                        <div class="col-lg-3 col-md-3 col-sm-12 col-xs-12">
                                                            <div class="md-input">
                                                                <asp:TextBox ID="txtTotalSubvetionamount" ToolTip="Subvention Amount" class="md-form-control form-control login_form_content_input requires_true" Enabled="false" runat="server">
                                                                </asp:TextBox>
                                                                <span class="highlight"></span>
                                                                <span class="bar"></span>
                                                                <label>
                                                                    <asp:Label ID="lblTotalSubvetionamount" CssClass="styleDisplayLabel" runat="server" ToolTip="Subvention Amount" Text="Subvention Amount"></asp:Label>
                                                                </label>
                                                            </div>
                                                        </div>
                                                        <%--                                                        <div class="col-lg-3 col-md-3 col-sm-12 col-xs-12">
                                                            <div class="md-input">
                                                                <asp:TextBox ID="TextBox2" ToolTip="Dealer Comission" class="md-form-control form-control login_form_content_input requires_true" Enabled="false" runat="server">
                                                                </asp:TextBox>
                                                                <span class="highlight"></span>
                                                                <span class="bar"></span>
                                                                <label>
                                                                    <asp:Label ID="Label4" CssClass="styleDisplayLabel" runat="server" ToolTip="Dealer Comission" Text="Dealer Comission"></asp:Label>
                                                                </label>
                                                            </div>
                                                        </div>--%>
                                                ...
                                                <div id="divLife" runat="server" style="background-color: rgba(247, 247, 247, 0.63);">
                                                    ...
                                                    <asp:Panel runat="server" ID="pnlLifeInsurance" ScrollBars="Auto" CssClass="stylePanel" GroupingText="Life Insurance"
                                                        ...
                                                        <div class="row">
                                                            ...
                                                            <div class="col-lg-3 col-md-3 col-sm-12 col-xs-12">
                                                                <div class="md-input">
                                                                    <asp:TextBox ID="txtInsuranceTaxRate" ReadOnly="true" class="md-form-control form-control login_form_content_input requires_true" Style="text-align: right" ToolTip="Life Insurance Company Amount" onkeyup="maxlengthfortxt(15);" runat="server"></asp:TextBox>

                                                                    <label>
                                                                        <asp:Label runat="server" ID="lblInsuranceTaxRate" ToolTip="Life Insurance Tax Rate" CssClass="styleDisplayLabel" Text="Life Insurance Company Tax Rate"></asp:Label>
                                                                    </label>
                                                                </div>
                                                            </div>
                                                            ...
                                                            <div class="col-lg-3 col-md-3 col-sm-12 col-xs-12">
                                                                <div class="md-input">
                                                                    ...
                                                                    <label>
                                                                        <asp:Label runat="server" ID="lblLifeInsuranceCompanyAmount" ToolTip="Life Insurance Company Amount (Excl. VAT)" CssClass="styleDisplayLabel" Text="Life Insurance Company Amount (Excl. VAT)"></asp:Label>
                                                                    </label>
                                                                </div>
                                                            </div>
                                                            ...
                                                            <div class="col-lg-3 col-md-3 col-sm-12 col-xs-12">
                                                                <div class="md-input">
                                                                    <asp:TextBox ID="txtInsuranceCompanyTaxAmount" ReadOnly="true" class="md-form-control form-control login_form_content_input requires_true" Style="text-align: right" ToolTip="Life Insurance Company Amount" onkeyup="maxlengthfortxt(15);" runat="server"></asp:TextBox>

                                                                    <label>
                                                                        <asp:Label runat="server" ID="lblInsuranceCompanyTaxAmount" ToolTip="Life Insurance Company Tax Amount" CssClass="styleDisplayLabel" Text="Life Insurance Company Tax Amount"></asp:Label>
                                                                    </label>
                                                                </div>
                                                            </div>
                                                            ...
                                                            <div class="col-lg-3 col-md-3 col-sm-12 col-xs-12">
                                                                <div class="md-input">
                                                                    <asp:TextBox ID="txtLifeInsuranceCompanyAmountWT" ReadOnly="true" class="md-form-control form-control login_form_content_input requires_true" Style="text-align: right" ToolTip="Life Insurance Company Amount" onkeyup="maxlengthfortxt(15);" runat="server"></asp:TextBox>
                                                                    <label>
                                                                        <asp:Label runat="server" ID="lblLifeInsuranceCompanyAmountWT" ToolTip="Life Insurance Company Amount (Incl. VAT)" CssClass="styleDisplayLabel" Text="Life Insurance Company Amount (Incl. VAT)"></asp:Label>
                                                                    </label>
                                                                </div>
                                                            </div>
                                                            ...
                                                            <div class="col-lg-3 col-md-3 col-sm-12 col-xs-12">
                                                                <div class="md-input">
                                                                    <asp:TextBox ID="txtInsuranceCustomerTaxAmount" ReadOnly="true" class="md-form-control form-control login_form_content_input requires_true" Style="text-align: right" ToolTip="Life Insurance Company Amount" onkeyup="maxlengthfortxt(15);" runat="server"></asp:TextBox>

                                                                    <label>
                                                                        <asp:Label runat="server" ID="lblInsuranceCustomerTaxAmount" ToolTip="Life Insurance Customer Tax Amount" CssClass="styleDisplayLabel" Text="Life Insurance Customer Tax Amount"></asp:Label>
                                                                    </label>
                                                                </div>
                                                            </div>
                                                            ...
                                                            <div class="col-lg-3 col-md-3 col-sm-12 col-xs-12">
                                                                <div class="md-input">
                                                                    <asp:TextBox ID="txtLifeInsuranceCustomerPremiumAmountWT" ReadOnly="true" class="md-form-control form-control login_form_content_input requires_true" Style="text-align: right" ToolTip="Life Insurance Company Amount" onkeyup="maxlengthfortxt(15);" runat="server"></asp:TextBox>
                                                                    <label>
                                                                        <asp:Label runat="server" ID="lblLifeInsuranceCustomerPremiumAmountWT" ToolTip="Life Insurance Customer Amount (Incl. VAT)" CssClass="styleDisplayLabel" Text="Life Insurance Customer Amount (Incl. VAT)"></asp:Label>
                                                                    </label>
                                                                </div>
                                                            </div>
                                    ...
                                    <asp:Panel ID="pnlCustomerMappingfortheAccount" runat="server" GroupingText="Client Customer Mapping for the Account" HorizontalAlign="Left" CssClass="stylePanel"
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-lg-3 col-md-4 col-sm-6 col-xs-12">
                                                <div class="md-input">
                                                    <asp:TextBox ID="txtLimitF" AutoPostBack="false" onchange="fnthousands_separators(this,1)" OnTextChanged="txtLimitAmnt_OntextChanged" runat="server" Style="text-align: right;"
                                                                            ...
                                                                            <asp:GridView ID="gvAssetDetails" class="gird_details" runat="server" AutoGenerateColumns="False" OnRowDeleting="gvAssetDetails_RowDeleting"
                                                                                ...
                                                                                <Columns>
                                                                                    ...
                                                                                    <asp:TemplateField HeaderText="Asset Cost">
                                                                                        <ItemTemplate>
                                                                                            <asp:Label ID="txtTOTALASSETVALUE" Text='<%#Bind("TOTALASSETVALUE") %>' runat="server"></asp:Label>
                                                                                        </ItemTemplate>
                                                                                    </asp:TemplateField>
                                                                                    <asp:TemplateField HeaderText="Finance Amount">
                                                                                        <ItemTemplate>
                                                                                            <asp:Label ID="txtFinanceAmount" Enabled="false" Text='<%#Bind("Finance_Amount") %>' runat="server"></asp:Label>
                                                                                        </ItemTemplate>
                                                                                    </asp:TemplateField>
                                        ...
                                        <asp:Panel ID="pnlFinanceDetailsFWC" runat="server" GroupingText="Finance Details" CssClass="stylePanel"
                                            ...
                                            <div class="row" style="padding: 0px !important; vertical-align: central">
                                                <div class="col-lg-3 col-md-3 col-sm-12 col-xs-12">
                                                    <br />
                                                    <div class="md-input">
                                                        <asp:TextBox ID="txtPrePaymentLimitFWC" class="md-form-control form-control login_form_content_input requires_true" ToolTip="Funding Limit" runat="server" AutoPostBack="false">
                                                        </asp:TextBox>
                                                        <%--onchange="funPrepaymentValidation();"--%>
                                                ...
                                                <div class="col-lg-3 col-md-3 col-sm-12 col-xs-12">
                                                    <br />
                                                    <div class="md-input">
                                                        <asp:TextBox ID="txtMarginFWC" onchange="funCalDebtPurchase();" ToolTip="Margin" runat="server" class="md-form-control form-control login_form_content_input requires_true" AutoPostBack="false">
                                                        </asp:TextBox>
                                                ...
                                                <div class="col-lg-3 col-md-3 col-sm-12 col-xs-12">
                                                    <br />
                                                    <div class="md-input">
                                                        <asp:TextBox ID="txtDebtPurchaseLimitFWC" ToolTip="Debt Purchase Limit" AutoPostBack="false" class="md-form-control form-control login_form_content_input requires_true" runat="server">
                                                        </asp:TextBox><%--onchange="funValidateCumilativeSubLimit();"- %>
                                                            OnTextChanged="txtDebtPurchaseLimitFWC_TextChanged"
                                                                    ...
                                                                    <asp:GridView ID="gvFACCharges" runat="server" class="gird_details" OnRowEditing="gvFACCharges_RowEditing" OnRowUpdating="gvFACCharges_RowUpdating" OnRowCancelingEdit="gvFACCharges_RowCancelingEdit" AutoGenerateColumns="False" EditRowStyle-CssClass="styleFooterInfo"
                                                                        ...
                                                                        <Columns>
                                                                            ...
                                                                            <asp:TemplateField HeaderText="Charge Amount">
                                                                                ...
                                                                                <FooterTemplate>
                                                                                    <div class="md-input" style="margin: 0px;">
                                                                                        <asp:TextBox ID="txtChargeAmount" onchange="fnthousands_separators(this,1)" ToolTip="Charge Amount" Width="100%"
                                                                                            runat="server" CssClass="md-form-control form-control login_form_content_input">
                                                                                        </asp:TextBox>
                                                                                ...
                                                                                <EditItemTemplate>
                                                                                    <div class="md-input" style="margin: 0px;">
                                                                                        <asp:TextBox ID="txtChargeAmountE" onchange="fnthousands_separators(this,1)" ToolTip="Charge Amount" Width="100%"
                                                                                            runat="server" CssClass="md-form-control form-control login_form_content_input">
                                                                                        </asp:TextBox>
                                                            ...
                                                            <asp:GridView ID="grvDiscountRateforUtilization" runat="server" class="gird_details" AutoGenerateColumns="False"
                                                                ...
                                                                <Columns>
                                                                    ...
                                                                    <asp:TemplateField HeaderText="Start Slab">
                                                                        ...
                                                                        <FooterTemplate>
                                                                            <div class="md-input" style="margin: 0px;">
                                                                                <asp:TextBox ID="txtStartSlabF" Width="100%"
                                                                                    runat="server" ToolTip="Start Slab" onchange="fnthousands_separators(this,1)" class="md-form-control form-control login_form_content_input">
                                                                                </asp:TextBox>
                                                                                <span class="highlight"></span>
                                                                                <span class="bar"></span>
                                                                                <div class="grid_validation_msg_box">
                                                                        ...
                                                                        <EditItemTemplate>
                                                                            <div class="md-input" style="margin: 0px;">
                                                                                <asp:TextBox ID="txtStartSlabE" onchange="fnthousands_separators(this,1)" Width="100%"
                                                                    ...
                                                                    <asp:TemplateField HeaderText="End Slab">
                                                                        ...
                                                                        <FooterTemplate>
                                                                            <div class="md-input" style="margin: 0px;">
                                                                                <asp:TextBox ID="txtEndSlabF" Width="100%" onchange="fnthousands_separators(this,1)" ToolTip="End Slab"
                                                                        ...
                                                                        <EditItemTemplate>
                                                                            <div class="md-input" style="margin: 0px;">
                                                                                <asp:TextBox ID="txtEndSlabE" onchange="fnthousands_separators(this,1)" Width="100%" ToolTip="End Slab"
                                                                                    runat="server" class="md-form-control form-control login_form_content_input">
                                                                                </asp:TextBox>
                                                                                <span class="highlight"></span>
                                                                                <span class="bar"></span>
                                                                    ...
                                                                    <asp:TemplateField HeaderText="Disc.Rate">
                                                                        ...
                                                                        <FooterTemplate>
                                                                            <div class="md-input" style="margin: 0px;">
                                                                                <asp:TextBox ID="txtDiscRateF" onchange="fnthousands_separators(this,1)" MaxLength="3" ToolTip="Disc.Rate" Width="100%"
                                                                                    runat="server" class="md-form-control form-control login_form_content_input">
                                                                                </asp:TextBox>
                                                                        ...
                                                                        <EditItemTemplate>
                                                                            <div class="md-input" style="margin: 0px;">
                                                                                <asp:TextBox ID="txtDiscRateE" MaxLength="3" onchange="fnthousands_separators(this,1)" ToolTip="Disc.Rate" Width="100%"
                                                                                    runat="server" class="md-form-control form-control login_form_content_input">
                                                                                </asp:TextBox>
                                                    ...
                                                    <asp:GridView ID="gvInflow" runat="server" AutoGenerateColumns="False" class="gird_details" OnRowDeleting="gvInflow_RowDeleting"
                                                        ...
                                                        <Columns>
                                                            ...
                                                            <asp:TemplateField HeaderText="Amount" ItemStyle-Width="11%" FooterStyle-Width="11%"
                                                                ...
                                                                <FooterTemplate>
                                                                    <div class="md-input" style="margin: 0px;">
                                                                        <asp:TextBox ID="txtAmount_Inflow" ToolTip="Amount" onchange="fnthousands_separators(this,1)" class="md-form-control form-control login_form_content_input requires_true" runat="server" MaxLength="10" Style="text-align: right">
                                                                        </asp:TextBox>
                                                                        <cc1:FilteredTextBoxExtender ID="ftextExtxtAmount_Inflow" runat="server" ValidChars=".," FilterType="Numbers,Custom"
                                                    ...
                                                    <asp:GridView ID="gvOutFlow" runat="server" AutoGenerateColumns="False" class="gird_details" OnRowDeleting="gvOutFlow_RowDeleting"
                                                        ...
                                                        <Columns>
                                                            ...
                                                            <asp:TemplateField HeaderText="Amount" ItemStyle-Width="11%" FooterStyle-Width="11%"
                                                                ...
                                                                <FooterTemplate>
                                                                    <div class="md-input" style="margin: 0px;">
                                                                        <asp:TextBox ID="txtAmount_Outflow" onchange="fnthousands_separators(this,1)" ToolTip="Amount" class="md-form-control form-control login_form_content_input requires_true" Width="95%" runat="server" MaxLength="10" Style="text-align: right">
                                                                        </asp:TextBox>
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
                                                <asp:Panel ID="Panel10" runat="server" CssClass="stylePanel" GroupingText="Repayment Summary"
                                                    Width="99%">
                                                    <div class="gird">
                                                        <asp:GridView ID="gvRepaymentSummary" OnRowDataBound="gvRepaymentSummary_RowDataBound" runat="server" class="gird_details" AutoGenerateColumns="false"
                                                            Width="100%">
                                                            <Columns>
                                                    ...
                                                    <asp:GridView ID="gvRepaymentDetails" class="gird_details" runat="server" AutoGenerateColumns="False"
                                                        ...
                                                        <Columns>
                                                            ...
                                                            <asp:TemplateField HeaderText="EMI" ItemStyle-Width="10%" FooterStyle-Width="10%"
                                                                ...
                                                                <FooterTemplate>
                                                                    <div class="md-input" style="margin: 0px;">
                                                                        <asp:TextBox ID="txtPerInstallmentAmount_RepayTab" onchange="fnthousands_separators(this,1)" ToolTip="Per Installment Amount" runat="server" Width="95%" Style="text-align: right;"
                            ...
                            <asp:UpdatePanel ID="upGuarantor" runat="server">
                                <ContentTemplate>
                                    <asp:Panel ID="Panel3" runat="server">
                                        <div class="row">
                                            <asp:Panel runat="server" ID="pnlGuarantorFromDMS" Width="100%" Visible="false" CssClass="stylePanel" GroupingText="New Guarantor Details From DMS">
                                                        ...
                                                        <asp:GridView ID="gvGuarantor" runat="server" AutoGenerateColumns="False" ShowFooter="True"
                                                            ...
                                                            <Columns>
                                                                ...
                                                                <asp:TemplateField HeaderText="Guarantee Amount"
                                                                    ...
                                                                    <FooterTemplate>
                                                                        <div class="md-input" style="margin: 0px;">
                                                                            <asp:TextBox ID="txtGuaranteeamount_GuarantorTab_Footer" onchange="fnthousands_separators(this,1)" ToolTip="Guarantee Amount" runat="server" Style="text-align: right"
                                                ...
                                                <Columns>
                                                    ...
                                                    <asp:TemplateField HeaderText="Description">
                                                        <ItemTemplate>
                                                            ...
                                                            <asp:Label ID="lblisPostbakc" Visible="false" runat="server" Text='<%#Eval("IS_POSTBACK")%>'>></asp:Label>
                                                    ...
                                                    <asp:TemplateField HeaderText="Value">
                                                        <ItemTemplate>
                                                            <asp:TextBox ID="lblVaue" class="md-form-control form-control login_form_content_input requires_true" AutoPostBack="false" OnTextChanged="lblVaue_TextChanged" Width="98%" runat="server" Text='<%#Eval("Appraisal_info_Value")%>'></asp:TextBox>
    ...
    <script language="javascript" type="text/javascript">
        ...
        function FunRestIrr() {
            ...
            fnthousands_separators("txtFinanceAmount", 2);
        }
